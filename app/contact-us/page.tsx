...
export default function Contact() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative h-[300px] w-full overflow-hidden bg-gradient-to-r from-amber-600 to-amber-700">
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="overflow-hidden rounded-lg">
            <div className="h-96 w-full bg-gradient-to-br from-amber-500/20 to-amber-700/20">
